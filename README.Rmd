...
```
<br>**It seems the amount of actors appearing on the show has increased relative to other occupations as the seasons progress.**
...
ggplot(seasons, aes(x = season, y = length, group = 1)) +
  ...
  labs(x = "Season Number", y = "Length") +  # Label axes
  theme_minimal() +  # Apply a minimal theme
  ggtitle("Length Over Time")  # Add a title
```
<br>**The first and second season were much longer than the others, with a sharp decline occurding after season 2 into season 3.**
